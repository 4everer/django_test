...
class AdminTest(BaseAcceptanceTest):
    ...
    def test_login(self):
        ...
        # Check response code
        response_login = self.client.get('/admin/', follow=True)
        self.assertEquals(response_login.status_code, 200)
        # Check 'Log out' in response_login
        self.assertTrue('Log out' in response_login.content)
    ...
    def test_edit_category(self):
        ...
        cate_id = Category.objects.all()[0].id
        response = self.client.post(
            '/admin/blogengine/category/{0}/'.format(cate_id),
            {
                'name': 'perl',
        ...
        self.assertEquals(
            only_category.description, 'The Perl programming language')
    ...
    def test_delete_category(self):
        ...
        cate_id = Category.objects.all()[0].id
        response = self.client.post(
            '/admin/blogengine/category/{0}/delete/'.format(cate_id),
            {
                'post': 'yes'
            }, follow=True)
        self.assertEquals(response.status_code, 200)
    ...
    def test_edit_tag(self):
        ...
        tags_id = Tag.objects.all()[0].id
        response = self.client.post(
            '/admin/blogengine/tag/{0}/'.format(tags_id),
            {
                'name': 'perl',
                'description': 'The Perl programming language'
            }, follow=True)
    ...
    def test_delete_tag(self):
        ...
        tags_id = Tag.objects.all()[0].id
        response = self.client.post(
            '/admin/blogengine/tag/{0}/delete/'.format(tags_id),
            {
                'post': 'yes'
            }, follow=True)
        self.assertEquals(response.status_code, 200)
